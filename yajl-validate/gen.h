...
do {                                                            \
  ...
  "   but edit the `%s' function in `%s' file instead.\n"       \
  "\n"                                                          \
...
bool gen_serialize_helper_c (yajl_val nodes, const char *  fname);
bool gen_serialize_buildstack_c (yajl_val nodes, const char *  fname);
